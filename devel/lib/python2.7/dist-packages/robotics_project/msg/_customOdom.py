...
"""autogenerated by genpy from robotics_project/customOdom.msg. Do not edit."""
import codecs
import sys
...
class customOdom(genpy.Message):
  _md5sum = "137ce4daeefae7f73f3f6058efe4b8cb"
  _type = "robotics_project/customOdom"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string odometry_type
...
float64 y
float64 z"""
  __slots__ = ['odometry_type','odometry']
  _slot_types = ['string','nav_msgs/Odometry']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(customOdom, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.odometry_type is None:
        self.odometry_type = ''
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.odometry_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.odometry_type = str[start:end]
      _x = self
      start = end
      end += 12
