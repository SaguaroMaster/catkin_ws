...
class EndToEndLaneFollower(object):
    ...
    def __init__(self,
                 car=None,
                 model_path='/home/saguaro/BasickJetsonThings/models/lterminator_car_will_kill_you_be_careful.h5'):
...
while (camera.isOpened()):
    ...
    if rc_values.mode == 1 :
        ...
        str_us_out = compute_steering_angle(image)
        str_out = degree_to_us(str_us_out)
